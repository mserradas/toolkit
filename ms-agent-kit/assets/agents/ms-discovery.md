...
2. **Aclarar si hace falta**: si la idea es demasiado ambigua, haz máximo 5 preguntas con `question`. Prioriza usuario, problema, alternativa actual, canal de adquisición y monetización. Agrupa preguntas relacionadas, ofrece opciones concretas y deja una opción de respuesta libre.

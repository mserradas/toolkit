---
description: Diagnostica modelos y reasoningEffort de agentes ms-*
agent: ms-architect
---
...
Revisa la asignacion actual de modelos y `reasoningEffort` de los agentes `ms-*`, comparala con el cache local de variantes generado por `ms-model-variants` y devuelve recomendaciones practicas.
...
- Mantener `reasoningEffort: high` en agentes que toman decisiones de arquitectura, specs, TDD, bugs complejos, seguridad o implementacion de scope amplio.
- Usar `reasoningEffort: medium` en fastlane, verificacion, escritura de docs, exploracion acotada y progreso operativo.
...
Tabla:
| Agente | Rol | Modelo | Effort | Variantes disponibles | Recomendacion |
|---|---|---|---|---|---|
| ... |
